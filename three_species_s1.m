...
a1 = 3.25;                  % hare hunting plant
a2 = 0.3;                   % lynx hunting hare
b1 = 7.69;                  % hare eating efficiency
b2 = 3.07;                  % lynx eating efficiency
d1 = 0.195;                 % hare natural death rate
d2 = 0.0325;                % lynx natural death rate
y0 = [0.8 0.5 0.2];       
